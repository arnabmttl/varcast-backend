...
use App\Models\VideoCommentMessage;
    ...
    */
    ...
    public function message_comment(Request $request) : JsonResponse {
        try {
            ...
            $validator = \Validator::make($request->all(),[
                'commentId' =>'required|exists:mongodb.video_comments,_id',
                'message' =>'required'
            ]);
            ...
            $params = $request->except('_token');
            $userId = $user->_id;
            $comment =  Helper::getSingleCollectionData('video_comments', $params['commentId']);
            $params['videoId'] = $comment['videoId'];
            $params['userId'] = $userId;

            $data = VideoCommentMessage::create($params);
    ...
    */
    ...
    public function comment_messages(Request $request,$id) : JsonResponse {
        try {
            ...
            $messages = VideoCommentMessage::with('user:_id,name,email,phone,image,govt_id_card')->where('commentId',$id)->orderBy('_id', 'desc')->get();
            return response()->json([
				'status' => false,
				'message' =>"Messages",
                'data' => $messages
